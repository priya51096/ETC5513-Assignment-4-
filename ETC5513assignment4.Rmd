...
C5 <- C4 %>% pivot_wider(names_from = educationlevel, values_from = unemployRATE)
...
```
   ...
   Generally speaking, most have lower unemployment rate compared to low education level groups, but this is not the case in TUR,PRT,RGC AND ITA.
